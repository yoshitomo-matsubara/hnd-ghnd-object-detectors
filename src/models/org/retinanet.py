...
from org.utils import BasicBlock, Bottleneck, BBoxTransform, ClipBoxes
from org.anchors import Anchors
from org import losses
...
def retinanet18(num_classes, pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(MODEL_URL_DICT['resnet18'], model_dir='.'), strict=False)
    return model
...
def retinanet34(num_classes, pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(MODEL_URL_DICT['resnet34'], model_dir='.'), strict=False)
    return model
...
def retinanet50(num_classes, pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(MODEL_URL_DICT['resnet50'], model_dir='.'), strict=False)
    return model
...
def retinanet101(num_classes, pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(MODEL_URL_DICT['resnet101'], model_dir='.'), strict=False)
    return model
...
def retinanet152(num_classes, pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(MODEL_URL_DICT['resnet152'], model_dir='.'), strict=False)
    return model
